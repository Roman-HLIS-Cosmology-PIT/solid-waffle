...
labels = [
    ...
    r"$\beta_4 g^3$",
    r"$[K^2a+KK^I]_{0,0}$",
    r"$[K^2a+KK^I]_{\langle 1,0 \rangle}$",
    r"$[K^2a+KK^I]_{\langle 1,1 \rangle}$",
    r"$[K^2a+KK^I]_{\langle 2,0 \rangle}$",
    r"$[K^2a+KK^I]_{\langle 2,1 \rangle}$",
    r"$[K^2a+KK^I]_{\langle 2,2 \rangle}$",
    r"$[K^2a+KK^I]_\mathrm{H}$",
