...
def read_summary(fname):
    """Extract summary data for plots in Freudenburg et al. (2020)."""
...
files = [
    prefix + "chris_20663st_summary.txt",
...
xdata_labels = ["alphaV", "alphaH", "beta2", "beta3", "beta4", "gain_alphabeta", "ipnl(0,0)", "ipnlNN"]
...
for i, sax in enumerate(sim_axes):
    ...
    for j, _ in enumerate(sim_ylabels):
